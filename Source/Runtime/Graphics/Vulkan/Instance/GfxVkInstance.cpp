...
namespace Flax
{
        ...
        m_physicalDevice(VK_NULL_HANDLE)
	{
        ...
        VDebug::VkAssert(vkCreateInstance(&createInfo, nullptr, &m_instance), "GfxVkInstance");
        ...
        VDebug::VkAssert(vkCreateDebugUtilsMessengerEXT(m_instance, &debugCreateInfo, nullptr, &m_debugMessenger), "GfxVkInstance");
#endif

        u32 deviceCount = 0;
        VDebug::VkAssert(vkEnumeratePhysicalDevices(m_instance, &deviceCount, nullptr), "GfxVkInstance");
        ...
        VDebug::VkAssert(vkEnumeratePhysicalDevices(m_instance, &deviceCount, devices.data()), "GfxVkInstance");
